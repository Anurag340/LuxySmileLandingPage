...
return (
    <div className='thirdpage relative h-screen w-full flex justify-center items-center'>
            <div className='z-[1] absolute h-[92%] w-[97%] rounded-3xl md:object-cover object-cover object-center overflow-hidden'>
                    <img className='w-full md:h-full h-full md:object-cover object-cover ' src="Images/bgimg2.png" alt="" />
            </div>

            <div className='z-[2] bgimg h-[95%] w-[97%] rounded-3xl flex flex-col'>
                    <div className='upperdiv flex h-[25%] md:h-[40%] w-full flex-col md:flex-row justify-between items-center p-0 m-0'>
                            <div className='textcontainer flex flex-col items-center md:items-start md:pl-[4vw] gap-[2vh] md:pt-[4vw] w-full md:w-[50%] h-full text-white'>
                                    <div className='tochange1 flex font-light justify-center items-center w-[60%] md:w-fit uppercase gap-[1vh] bg-white/10 backdrop-blur-md p-[1vh] px-[2vh] rounded-full text-[13px] md:text-base mt-8 '>
                    ...
                    <div className='lowerdiv h-[53%] md:h-[60%] w-full rounded-b-3xl flex flex-col items-center gap-[1vh]'>
                            <div className='firsthalf md:h-[40%] h-fit flex flex-col md:flex-row justify-center items-center gap-[1vh] px-[2%] w-full'>
                                    ...
                                    <div className='card w-full md:w-[47%] md:h-[100%] h-fit flex flex-row md:flex-col justify-start md:justify-center items-start gap-[1vh] pl-[2vw] rounded-3xl py-[2vw] md:py-0'>
                            ...
                            <div ref={register} className='secondhalf flex h-[47%] gap-4 w-full md:flex-row flex-col justify-center items-center px-[2vw] mt-8 md:mt-0'>
                                    <div className='card w-full md:w-[30%] h-[25vw] md:h-[80%] rounded-3xl bg-[var(--luxbg)] flex flex-row md:flex-col justify-start md:justify-center items-start gap-[1vh] pl-[2vw] py-[2vw] md:py-0'>
