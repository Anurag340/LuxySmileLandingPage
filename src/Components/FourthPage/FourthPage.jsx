...
const FourthPage = () => {
    ...
    return (
        <div className='fourthmaindiv flex flex-col md:flex-row min-h-screen w-full'>
            <div className='fourthtextdiv w-full md:w-[40%] h-full px-4 md:pl-[4vw] pt-[6vh] md:pt-[3vw] flex flex-col gap-[2vh]'>
                <div className='textdiv flex flex-col justify-center items-start gap-[1vh]'>
                    <p className='fourthmaintext uppercase text-2xl md:text-4xl font-medium'>Individuals</p>
                    <p className='fourthsubtext text-base md:text-lg font-light tracking-wide'>Personalized Insights. Accessible Anytime.</p>
                </div>
                <p className='text-xl md:text-3xl fourthsub2text'>Empowering healthier <span>lifestyles</span>-one <span>individual</span> at a time.</p>
            </div>

            <div className='carddiv w-full md:w-[60%] h-full flex flex-col items-center gap-[2vh] py-[4vh] md:pt-[1vw] md:pb-[1vw]'>
                <div className='cards w-[90%] md:w-[65%] h-fit pb-[4vh] md:pb-[2vw] bg-white rounded-3xl px-4 md:pl-[2vw] pt-[2vh]'>
                ...
                <div className='flex flex-col justify-center items-center gap-[2vh] w-full hidden' ref={register}>
                    <div className='cards w-[90%] md:w-[65%] h-fit pb-[4vh] md:pb-[2vw] bg-white rounded-3xl px-4 md:pl-[2vw] pt-[2vh]'>
                        <div className='icondiv w-fit p-[1vh] bg-white rounded-xl shadow-black shadow-2xl'><GiVrHeadset className='icons' size={25} /></div>
                        <div>
                ...
                <button onClick={toggleTiles} className='p-[1.2vh] px-[6vw] md:px-[4vw] shadow-black shadow-2xl showmorebutton text-white rounded-full mt-4'>
                    {text}
                </button>
            </div>
        </div>
