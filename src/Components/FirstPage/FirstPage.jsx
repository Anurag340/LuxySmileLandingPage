...
const FirstPage = () => {
  return (
    <div className='h-screen w-full flex justify-center items-center relative object-cover object-center overflow-hidden ' >
      <div  className='h-[95%] w-[97%] rounded-3xl fimg object-cover object-center overflow-hidden ' >
      <img className='h-full w-full '  src="Images/heroimg.jpg" alt="" />
      </div>
      

        <div className='absolute heroimg h-[95%] w-[97%] rounded-3xl bg-cover bg-center flex flex-col gap-[3%] justify-center items-center ' >
